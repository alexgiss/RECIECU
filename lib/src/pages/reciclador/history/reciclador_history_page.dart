...
import 'package:local/src/pages/reciclador/history/reciclador_history_controller.dart';
import 'package:local/src/utils/relative_time_util.dart';
import 'package:local/src/utils/colors.dart' as utils;
class RecicladorHistoryPage extends StatefulWidget {
  @override
  _RecicladorHistoryPageState createState() => _RecicladorHistoryPageState();
}

class _RecicladorHistoryPageState extends State<RecicladorHistoryPage> {

  RecicladorHistoryController _con = new RecicladorHistoryController();
            ...
            return ListView.builder(
                ...
                itemBuilder: (_, index) {
                  return _cardHistoryInfo(
                    ...
                    snapshot.data[index].nameProductor,
                    snapshot.data[index].detalle,
                    snapshot.data[index].calificationProductor?.toString(),
