...
import 'package:local/src/pages/reciclador/viaje_calification/reciclador_viaje_calification_controller.dart';
import 'package:local/src/widgets/button_app.dart';
import 'package:local/src/utils/colors.dart' as utils;
class RecicladorViajeCalificationPage extends StatefulWidget {

  @override
  _RecicladorViajeCalificationPageState createState() => _RecicladorViajeCalificationPageState();
}

class _RecicladorViajeCalificationPageState extends State<RecicladorViajeCalificationPage> {
  RecicladorTravelCalificationController _con= new RecicladorTravelCalificationController();
  @override
  void initState() {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          _listTileTravelInfo('Oferta', _con.travelHistory?.detalle ?? '', Icons.add_shopping_cart_outlined),
          SizedBox(height: 10),
